...
Expressing clear thoughts with a logical perspective should be everyone's goal.
...
Adult life is more than just a multiple-choice test. Go beyond “what?” and ask “how?” and “why?” Finding answers to “What are the main causes of lack of critical thinking?” can be answered with a quick web search. But this type of knowledge is superficial. To build rigorous knowledge, we need to go beyond simple facts and web search. We can all improve critical thinking by asking a few extra questions each day. [3]

### Socratic Method
To ask continual questions, Socrates, a Greek philosopher who sought to get to the bottom of his students’ views used continual questions until a contradiction was exposed. This challenges the initial assumption of his students. Asking continual questions is known as the Socratic Method. [4]

The Socratic Method pushes for critical thinking and finding holes in assumptions. Questions to promote critical thinking:

1. Why does X cause Y to happen?
2. How will making a decision impact others?
3. What is the hardest part of this problem you are working on?
4. How can you overcome constraints you are dealt with?
5. Can you back your thesis with a set of data points?
6. How did you know this?
7. Why did you fail and what did you learn from it?
8. What important truth do very few people agree with you on?
9. Where does conviction and ambition come from? How can you get more of it?
10. Why ask great questions?
...
Traditional essays do not allow to explore questions, but rather explore answers to a specific question. A quick web search can point me to all possible answers. I can beautify my essay with a flavor of rhetoric and perfect grammar. Paul Graham has written an excellent piece [5] on this topic.
...
---
**References**
1. [1] http://www.paulgraham.com/identity.html
2. [2] https://theamericanscholar.org/solitude-and-leadership/
3. [3] https://blog.ed.ted.com/2019/05/09/critical-thinking-is-a-21st-century-essential-heres-how-to-help-kids-learn-it/
4. [4] https://en.wikipedia.org/wiki/Socratic_method
5. [5] http://www.paulgraham.com/essay.html
6. [6] https://luttig.substack.com/p/timeful-advice

**Articles**
1. https://ed.ted.com/lessons/this-tool-will-help-improve-your-critical-thinking-erick-wilberding
2. https://ideas.ted.com/how-to-make-your-arguments-stronger-hint-longer-is-not-the-answer/
https://en.wikipedia.org/wiki/Logic

**Books**
1. 1984 by George Orwell
2. A Brave New World by Aldous Huxley
3. Being Logical, A Guide to Good Thinking by Dennis Q. McInerny
