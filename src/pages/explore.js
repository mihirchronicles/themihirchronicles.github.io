...
const IndexPage = ({ data }) => {
  return (
    <Layout>
      ...
      <Content>
      <h1>Explore</h1>
      <Description>“If I have seen further it is by standing on the shoulders of giants.” - Isaac Newton. Sir Isaac Newton knew the trick when he was on a quest for finding gravity. Besides books, I follow these interesting people below. I widen my ears and illuminate my focal point when they have something to say. The only way to climb the hierarchy of rational thinking is to stand on giant shoulders. There are many other giant shoulders that I follow but it would turn into an exhaustive list. Resources below are mostly centered around my interest in investing and philosophy which are in form of shareholder letters and long-form reading posts.</Description>
        <h2>Letters</h2>
        <ol>
          <li><a href="http://www.berkshirehathaway.com/">Munger and Buffett</a></li>
