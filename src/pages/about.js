    ...
    <Layout>
      ...
      <About>
        ...
        <AboutContent>
          ...
          <p><strong>The game of investing</strong> in markets is always fun. There is no better way to learn about the real world than throwing ourselves out there. I purchased my first stock at the age of 17, which also happend to be right before the 2008 recession. In a few months, I lost all my savings that I accumulated from my summer jobs. This is when understanding the psychology of markets became fascinating to me. In the end, markets are people. If we understand markets, we understand people, and vice-versa.</p>
          ...
          <p>Lastly, <strong>the game of finding harmony with our soul</strong>. I truly cherish immersing into different cultures, being out in the woods, hiking trails, climbing mountains, gazing at stars, reading in solitude, teaching kids about life and creating things. When I pursue these things, I am in my truest element. There is no pain and more importantly my soul is most alive! All these things help me build surplus of positive energy. All I am striving for is to keep building on this momentum. Aristotle and Kobe Bryant said it best on habits and choices:</p>
          <blockquote>We are what we repeatedly do. Excellence, then, is not an act, but a habit. — Aristotle</blockquote>
          <blockquote>We all can be masters at our craft, but you have to make a choice. What I mean by that is, there are inherent sacrifices that come along with that. Family time, hanging out with friends, being a great friend, being a great son, nephew, whatever the case may be. — Kobe Bryant</blockquote>
        </AboutContent>
      </About>
      <Horizontal/>
      <h2>Milestones</h2>
