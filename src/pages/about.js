  ...
  return (
    <Layout>
      ...
      <About>
        ...
        <AboutContent>
          <p>Exploration has always been dear to my heart. Learning as a currency is more valuable to me than anything else. Fancy titles and achievements are traps. I hope learning does not change as I get older. Learning is one thing, but teaching is another. The latter is much harder to strive for because we have to put our demons like ego and selfish acts to rest. I hope to share what I learn with others via this website.</p>
          <p><strong>The game of studying markets</strong> is always fun because it challenges you to adapt. There is no better way to learn about the real world than throwing yourself out there. I purchased my first stock at the age of 17, which also happened to be right before the 2008 recession. In a few months, I lost all my savings that I accumulated from my summer jobs. The pain from losing was tough to swallow, but I learned many important lessons at an early age. This is when understanding the psychology of markets and businesses became fascinating to me. In the end, markets are people. If we understand markets, we understand people, and vice-versa.</p>
