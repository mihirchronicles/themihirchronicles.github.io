  ...
  return (
    <Layout>
      ...
      <About>
        ...
        <AboutContent>
          <p>This website is an open exploration with others. Exploration has always been dear to my heart. I do not use the term “exploration” loosely. I have always put a huge emphasis on exploring and following my own curiosity. Learning as a currency is more valuable to me than cash. Fancy titles and achievments are traps. The soul wide opens when I am interested, not interesting. I hope learning does not change as I get older. Learning is one thing, but teaching is another. The latter is much harder to strive for because we have to put our demons like ego and selfish acts to rest.</p>
          ...
          <p><strong>On :</strong></p><blockquote>Anything achieved through brute force never lasts. You must change the structure of the system if you want to have any sort of long-term impact. — Robert Fritz</blockquote>
