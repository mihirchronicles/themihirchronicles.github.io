  ...
  return (
    <Layout>
      ...
      <About>
        ...
        <AboutContent>
          <p>Exploration has always been dear to my heart. I do not use the term "exploration" loosely. If we look at the challenges below, I have always put a huge emphasis on exploring and following my own curiosity. And I hope that does not change as I get older. I am using this blog as a platform to learn openly in public and share those gems with others as I find them interesting. Learning is one thing, but teaching is another. The latter is much harder to strive for because we have to put Our demons like ego and selfish acts to rest.</p>
          <p>The game of investing in markets is always fun. There is no better way to learn about real world than throwing ourself out there. I purchased my first stock at the age of 17, which also happend to be right before the 2008 recession. In a few months, I lost all of my savings that I accumulated from my summer jobs. This is when understanding the psychology of markets became fascinating to me. In the end, markets are people, corporations, government and everything else in between. If we understand markets, we understand people, and vice-versa.</p>
          ...
          <p><strong><i>Ralph Waldo Emerson said it best about leadership and friendship, “He who should inspire and lead his race must be defended from travelling with the souls of other men, from living, breathing, reading, and writing in the daily, time-worn yoke of their opinions. The soul environs itself with friends, that it may enter into a grander self-acquaintance or solitude.”</i></strong></p>
        </AboutContent>
      </About>
      <Horizontal/>
      <h2>Challenges</h2>
      ...
      <h2>Principles</h2>
        <ol>
          <li><strong>Honesty:</strong> without honesty none of the values below matter. we not only have to be honest to others but to ourself, Our subconscious and every decision we make. Honesty is the highest honor we will carry. It'll help we preserve Our reputation and integrity. Be ruthless if integrity is ever being questioned. Protect Our reputation. It takes years to build it and minutes to ruin it. If we don’t ask, we don’t get. If we don’t question we don’t know. Authenticity and originality is born when we are honest to ourself and others around us. Owning our actions can be incredibly difficult to do. We aren’t programmed to expose our egos or make ourselves vulnerable when we make mistakes or do something stupid. But one of the most powerful ways to make giant leaps forward in our lives is to not only accept that we’ll screw up, but to actively seek out correction when we do. When we refuse to accept ownership of our mistakes, we’ve warped the feedback loop we rely on to make better decisions in the future.</li>
          <li><strong>Respect and Be Kind:</strong> respect everything around we - people, tasks, time, money and relationships. If we can't respect them then don't be around them. Be empathetic! we can respect others by giving them 3 things: being reliable, giving them 100% attention and making them feel good about themselves. we never know what others are going through. Be compassionate, respectful and never forget to smile.</li>
          <li><strong>Intense Focus:</strong> focus is a force multiplier on work. Without intense focus everything else fails. And focusing on too many things is a recipe for a failure. Focus on only 1 thing until we finish it. Cultivate trust and attention. Protect Our attention like we protect Our friends, family, and money. Commit to Our goal with everything we have — for a season. Direction over speed. If we are pointed in the wrong direction, it doesn’t matter how fast we are traveling. Inversely, if we are locked on to Our desired destination, all progress is positive, no matter how slow we are going. we will reach Our destination eventually with intense focus and ruthlessly prioritizing!</li>
          <li><strong>Hard Work and Hard Problems:</strong> skills will only take we far but work ethic will define Our character. Wake up before the sunrise and work till the sunset. Also work on hard problems. When we solve hard problems, we are alive and relieved after solving. we can get to about the 90th percentile in Our field by working either smart or hard, which is still a great accomplishment. But getting to the 99th percentile requires both—we will be competing with other very talented people who will have great ideas and be willing to work a lot. Working a lot comes with huge life trade-offs but momentum compounds, and hard work begets progress.</li>
          <li><strong>Long-Term:</strong> always think about Our objectives with a long-term view. Compound Interest is the most underrated law. Extreme patience with extreme focus with extreme decisiveness with a long-term view will do magic and wonders. It’s amazing how much of a competitive advantage can be found by simply having the disposition to wait longer than Our competitors.</li>
          <li><strong>Repition, Effort and Deliberate Practice:</strong> be so good that they can't ignore us. Key to becoming good to so good is to do boring tasks over and over again until we perfect it. Doing new and cool things is sexy but doing repetitive task is not. It will take many tries till we perfect Our art. Use space repetition technique and focused/diffused mode. Consistency is the playground for perfection. Effort counts not passion; effort counts not talent. Deliberate practice is a key to repetition. Structured but flexible repetition is the best productivity tool. It doesn't matter what we are trying to become better at, if we only do the work when it’s convenient or exciting, then we will never be consistent enough to achieve remarkable results. The ability to show up everyday, stick to the schedule, and do the work — especially when we don't feel like it — is so valuable that it is literally all we need to become better 99% of the time.</li>
