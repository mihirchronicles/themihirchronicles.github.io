    ...
    <Layout>
      ...
      <About>
        ...
        <AboutContent>
          ...
          <p>The game of investing in markets is always fun. There is no better way to learn about real world than throwing ourselves out there. I purchased my first stock at the age of 17, which also happend to be right before the 2008 recession. In a few months, I lost all of my savings that I accumulated from my summer jobs. This is when understanding the psychology of markets became fascinating to me. In the end, markets are people, corporations, government and everything else in between. If we understand markets, we understand people, and vice-versa.</p>
      ...
      <h2>Principles</h2>
        <ol>
          ...
          <li><strong>XIV.Optimism and positivity:</strong> be realist but optimistic and make wise choices. Our decisions will define Our process and path, so choose wisely. Asking a question in a positive manner generates a better response. Example: “'Preacher, can I smoke while I'm praying?' Answer: No. 'Preacher, can I pray whilst I'm smoking?' Answer: Of course you can.” Positive thinking is an incredibly powerful tool. Positive, proactive behavior spurs positive and proactive behavior. The pessimist sees the difficulty in every opportunity but an optimist sees the opportunity in every difficulty. Positive people don't just have a good day but they make it a good day. People who think positively usually see endless possibilities. Success doesn't create optimism but optimism leads to progress. Do not compare and neither judge others. Cut negative people and negative energy out instantly.</li>
