    ...
    <Layout>
      ...
      <About>
        ...
        <AboutContent>
          ...
          <p><strong>My guiding principle</strong>: the opposite of play is not work, but depression. Life is a game then. Ready, Set, Go! Play the game of inches by taking small and incremental steps instead of giant leaps. The way to stay in the game for a long time is to work on hard problems which provides motivation and energy.</p>
