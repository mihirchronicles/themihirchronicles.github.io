...
const IndexPage = ({ data }) => {
  return (
    <Layout>
      ...
      <Content>
      <h1>Work</h1>
      <p>My work has always consisted of some variation of building products. There is a pure joy in building and launching creative products. Building a product is like planting a seed while experimenting with new ideas and bringing chaos in order. The journey of building products has given me insights on various topics. My work is still in progress. Below you will find my past and present product stories.</p>
      <Horizontal/>
      <WorkContainer>
