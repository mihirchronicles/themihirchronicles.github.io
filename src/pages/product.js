...
const ProductTitle = styled.h1`
  border-bottom: 2px solid #70a2d1;
  padding-bottom: 5px;
`
...
const IndexPage = ({ data }) => {
  return (
    <Layout>
      ...
      <Product>
        <ProductTitle>Wise Charlie, 2018-Current</ProductTitle>
      ...
      <Product>
        <ProductTitle>Morningstar Design System, 2018-Current</ProductTitle>
      ...
      <Product>
        <ProductTitle>Spend Out, 2013</ProductTitle>
